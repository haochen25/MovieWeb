...
{
    /// <inheritdoc />
    public partial class TrailerAndMovieGenreMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaseDate = table.Column<DateTime>(type: "datetime2", maxLength: 7, nullable: true),
                    RunTime = table.Column<int>(type: "int", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", maxLength: 7, nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", maxLength: 7, nullable: true),
